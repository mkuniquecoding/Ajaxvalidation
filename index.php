		...
		<div class="content">
			...
			<div id="message" class="bg-success p-2 text-white">
			  ...
			  <form method="post" id="userform">
			  	<div id="first">
			  		<div id="address-info" style="background: #FEAF44; padding: 10px; margin-bottom: 10px;">
			  			<h3 style="color: #fff; text-align: center;">Personal Details</h3>
			  		</div>
			...
			<p>Have already an account,<a href="user_login.php">login here</a></p>
	...
	$(document).ready(function(){
			...
			$('#submit').click(function(e){
				...
				if ($('#addr').val() =='') {
					...
					$.ajax({
						url:'user_registration_data.php',
						method:"post",
						data: $('form').serialize(),
						dataType: "text",
